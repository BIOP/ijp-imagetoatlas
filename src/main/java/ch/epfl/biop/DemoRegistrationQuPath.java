...
public class DemoRegistrationQuPath {
	...
	public static void main(String[] args) throws Exception {
        ...
        String scriptTest =
                "run(\"Open [QuPath Project]\", \"unit=MILLIMETER splitrgbchannels=false positioniscenter=AUTO switchzandc=AUTO flippositionx=AUTO flippositiony=AUTO flippositionz=AUTO usebioformatscacheblocksize=true cachesizex=512 cachesizey=512 cachesizez=1 refframesizeinunitlocation=1.0 refframesizeinunitvoxsize=1.0 qupathproject=[C:\\\\Users\\\\nicol\\\\Dropbox\\\\BIOP\\\\19-05-24 VSI Samples\\\\align\\\\QP0.2.1\\\\project.qpproj]\");\n" +
