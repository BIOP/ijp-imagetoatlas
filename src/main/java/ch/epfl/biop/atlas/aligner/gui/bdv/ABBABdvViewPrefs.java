...
public class ABBABdvViewPrefs {
   ...
   public static Color valid_action_string_color = new Color(255, 255, 255, 200);
   ...
   public static Color color_export_to_roimanager_action = new Color(255, 255, 255, 200);
   public static Color export_deformation_field_action_text_color = new Color(255, 255, 255, 200);
   public static Color color_export_atlas_to_image_plus_action = new Color(255, 255, 255, 200);
   public static Color export_slice_region_to_file_string_action = new Color(255, 255, 255, 200);
   public static Color export_slice_regions_to_qupath_string_color = new Color(255, 255, 255, 200);
   ...
   public static Color color_export_slice_to_image_plus_action = new Color(255, 255, 255, 200);
